...
int main() {
  ...
  // tokenizer
  CstringWrapper * str = new CstringWrapper(), * str_adapter = new CstringWrapper(), * str_timer = new CstringWrapper(), * str_writer = new CstringWrapper(), * str_status = new CstringWrapper();
  // str for c strings
  TokenizerList<
    string,
    CstringWrapper,
